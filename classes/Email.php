...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        $contenido .= "<p><strong>Hola, " . $this->nombre . "</strong> Has creado tu cuenta en AppSalon,
                        confirma con el siguiente enlance </p>";
        $contenido .= "<p>Presiona aquí: <a href='" . $_ENV['APP_URL'] . "/confirmar-cuenta?token=". $this->token . "'
                        >Confirmar Cuenta</a> </p>";
        $contenido .= "<p>Si tu no solicistaste esta cuenta ignora el mensaje</p>";
        $contenido .= "</html>";
    ...
    public function enviarInstrucciones() {
        ...
        $mail->SMTPAuth = true;
        $mail->Port = 2525;
        $mail->Username = 'ee8c27ba12c0d4';
        $mail->Password = '7bff66c9206621';
